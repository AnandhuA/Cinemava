...
class AnimeStatusBadges extends StatelessWidget {
  const AnimeStatusBadges({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    final isWatched = provider.isWatched(animeId);
    final isSaved = provider.isInWishlist(animeId);
